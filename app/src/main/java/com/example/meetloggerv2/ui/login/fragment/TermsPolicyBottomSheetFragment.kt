...
class TermsPolicyBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_terms_policy_bottomsheet, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val policyTextView = view.findViewById<TextView>(R.id.policyText)
        ...
        if (type == "terms") {
            dialogTitle.text = "Terms of Service"
            policyTextView.text = getTermsOfServiceText()
        } else {
            dialogTitle.text = "Privacy Policy"
            policyTextView.text = getPrivacyPolicyText()
        }
    }
