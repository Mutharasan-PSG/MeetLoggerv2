...
class AudioListViewModel(
    ...
    fun downloadAudioFile(userId: String, fileName: String, destination: File, onComplete: (Boolean, Exception?) -> Unit) {
        audioRepository.downloadAudioToFile(userId, fileName, destination, onComplete)
    }

    fun getAudioDownloadUrl(userId: String, fileName: String, onComplete: (String?, Exception?) -> Unit) {
        audioRepository.getAudioDownloadUrl(userId, fileName, onComplete)
    }

    fun downloadAudioBytes(userId: String, fileName: String, onComplete: (ByteArray?, Exception?) -> Unit) {
        audioRepository.downloadAudioBytes(userId, fileName, onComplete)
    }
