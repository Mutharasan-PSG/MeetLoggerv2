...
class ReportFragment : Fragment() {
    ...
    private fun showDeleteConfirmationDialog() {
        MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton(R.string.dialog_delete) { _, _ ->
                val userId = authSession.currentUserId() ?: return@setPositiveButton
    ...
    private fun finishRenaming() {
        ...
        if (name.isNotEmpty() && oldFull != null) {
            ...
            viewModel.renameFile(authSession.currentUserId() ?: "", oldFull, "$name.$ext")
        }
        cleanupRenamingMode()
    }
    ...
    private fun performExport(name: String, format: String) {
        ...
        viewModel.fetchFileDetails(authSession.currentUserId() ?: "", full) { content ->
