...
object UIUtils {
    ...
    fun setupSearchViewClickToFocus(searchView: androidx.appcompat.widget.SearchView) {
        ...
        // Scale search text size based on device dimensions
        val textSize = searchView.context.resources.getDimension(R.dimen.text_size_normal)
        searchAutoComplete?.setTextSize(android.util.TypedValue.COMPLEX_UNIT_PX, textSize)
